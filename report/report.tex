...
\begin{table}[htbp]
\caption{\label{list}List of 13 field trials used in this study.}
\centering
\begin{tabular}{|ccccc|}
\hline
...
\label{sec:org06466ad}

\section{Results}
\label{sec:orgba344ad}
\subsection{Simulated experiments}
\label{sec:org8f9cbf1}
