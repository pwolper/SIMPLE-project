...
\begin{tabular}{ccccc}
\hline
\textbf{Time {[}year{]}} & \textbf{Location} & \textbf{Water {[}yes/no{]}} & \textbf{Label} & \textbf{Trial period {[}month{]}} \\ \hline
2018 & Rio Paranaiba & no  & irrigated    & 5-9  \\
2019 & Rio Paraneiba & no  & irrigated    & 5-10 \\
2019 & Vicosa        & no  & irrigated    & 6-10 \\
2020 & Vicosa        & no  & irrigated    & 6-10 \\
2020 & Vicosa        & yes & nonirrigated & 6-10 \\
2021 & Vicosa        & no  & irrigated    & 6-10 \\
2020 & Sao Gotardo   & no  & irrigated    & 5-8  \\
2020 & Sao Gotardo*  & yes & nonirrigated & 7-11 \\
2021 & Sao Gotardo   & no  & irrigated    & 4-9  \\
2021 & Sao Gotardo*  & yes & nonirrigated & 3-8  \\
2022 & Sao Gotardo*  & yes & nonirrigated & 3-8  \\
2020 & Sete Lagoas   & no  & irrigated    & 7-11 \\
2021 & Itutinga      & yes & nonirrigated & 3-8  \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{tabular}{ccccc}
\hline
\textbf{} & \textbf{r\_squared} & \textbf{mae} & \textbf{rmse} & \textbf{md} \\ \hline
All       & 0.226               & 1131.89      & 1499.29       & 0.435       \\
healthy   & 0.254               & 717.22       & 890.4         & 0.349       \\
Vicosa    & 0.336               & 354.35       & 442.34        & 0.479       \\ \hline
\end{tabular}%
}
\end{table}
