...
The species and cultivar parameters required by the SIMPLE mode were derived from literature or estimated based on similar species. (*cite zhao et al.*) Further calibrated was done by adjusting cultivar parameters (Tsum, I50A, I50B and HI) within reasonable levels.
...
(add some location-specific model statistics.)
