...
simName <- "yield_prediction_cc_model"
...
plot <- ggplot(cc_model,aes(x=Label,y=Yield))+
  ...
  labs(caption = "Fig. 4", x = "Year", y = "Simulated yield (t ha-1)")
ggsave(paste0(filename,".png"),plot,device = "png", width = 10, height = 8, bg = "white")
